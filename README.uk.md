...
- **Дашборд** із графіками Swift Charts для CPU, памʼяті, load і мережі (від 15 хв до 24 год), топ процесів і відфільтрований журнал.
...
Прапорці запуску: `--dashboard` одразу відкриває дашборд, `--settings` відкриває налаштування, `--import` імпортує хости з `~/.ssh/config` і виходить.
